...
n_rank_http = {
    "parameters": {
        ...
        "sendBody": True,
        "specifyBody": "json",
        "jsonBody": "={{ { \"model\": \"openai/gpt-oss-120b\", \"messages\": [ { \"role\": \"user\", \"content\": $('Filter Candidates').item.json.rankPrompt } ], \"max_tokens\": 700 } }}",
        "options": {},
    },
...
n_http_ai = {
    "parameters": {
        ...
        "sendBody": True,
        "specifyBody": "json",
        "jsonBody": "={{ { \"model\": \"openai/gpt-oss-120b\", \"messages\": [ { \"role\": \"user\", \"content\": $('Select by Fit').item.json.aiPrompt } ], \"max_tokens\": 350 } }}",
        "options": {},
    },
...
f_http_ai = {
    "parameters": {
        ...
        "sendBody": True, "specifyBody": "json",
        "jsonBody": "={{ { \"model\": \"openai/gpt-oss-120b\", \"messages\": [ { \"role\": \"user\", \"content\": $('Score & Draft Bid').item.json.aiPrompt } ], \"max_tokens\": 350 } }}",
        "options": {},
    },
